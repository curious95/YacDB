			...
			for (String url : urlSet) {
				...
				try {
					builder = ingestor.driver.findElement(By.xpath(
							"/html/body/div[4]/div[2]/div/div[3]/div/div/div/div[1]/div[1]/ul/li[1]/table/tbody/tr/td[2]"))
							.getText();
				...
				try {
					type = ingestor.driver.findElement(By.xpath(
							"/html/body/div[4]/div[2]/div/div[3]/div/div/div/div[1]/div[1]/ul/li[2]/table/tbody/tr/td[2]"))
							.getText();
					ych.setType(type);
				} catch (Exception e) {
					// TODO: handle exception
				...
				try {
					yac_model = ingestor.driver.findElement(By.xpath(
							"/html/body/div[4]/div[2]/div/div[3]/div/div/div/div[1]/div[1]/ul/li[3]/table/tbody/tr/td[2]"))
							.getText();
				...
				try {
					year = ingestor.driver.findElement(By.xpath(
							"/html/body/div[4]/div[2]/div/div[3]/div/div/div/div[1]/div[1]/ul/li[5]/table/tbody/tr/td[2]"))
							.getText();
					ych.setYear(year);
				} catch (Exception e) {
					// TODO: handle exception
				...
				try {
					flag = ingestor.driver.findElement(By.xpath(
							"/html/body/div[4]/div[2]/div/div[3]/div/div/div/div[1]/div[2]/ul/li[1]/table/tbody/tr/td[2]"))
							.getText();
					ych.setFlag(flag);
				} catch (Exception e) {
					// TODO: handle exception
				...
				try {
					length_overall = ingestor.driver.findElement(By.xpath(
							"/html/body/div[4]/div[2]/div/div[3]/div/div/div/div[2]/div[1]/ul/li[1]/table/tbody/tr/td[2]"))
							.getText();
				...
				try {
					length_at_waterline = ingestor.driver.findElement(By.xpath(
							"/html/body/div[4]/div[2]/div/div[3]/div/div/div/div[2]/div[1]/ul/li[2]/table/tbody/tr/td[2]"))
							.getText();
				...
				try {
					max_speed = ingestor.driver.findElement(By.xpath(
							"/html/body/div[4]/div[2]/div/div[3]/div/div/div/div[3]/div[1]/ul/li[4]/table/tbody/tr/td[2]"))
							.getText();
				...
				try {
					range = ingestor.driver.findElement(By.xpath(
							"/html/body/div[4]/div[2]/div/div[3]/div/div/div/div[3]/div[1]/ul/li[3]/table/tbody/tr/td[2]"))
							.getText();
					ych.setRange(range);
				} catch (Exception e) {
					// TODO: handle exception
				...
				try {
					fuel_capacity = ingestor.driver.findElement(By.xpath(
							"/html/body/div[4]/div[2]/div/div[3]/div/div/div/div[3]/div[2]/ul/li[5]/table/tbody/tr/td[2]"))
							.getText();
				...
				try {
					gross_tonnage = ingestor.driver.findElement(By.xpath(
							"/html/body/div[4]/div[2]/div/div[3]/div/div/div/div[3]/div[2]/ul/li[2]/table/tbody/tr/td[2]"))
							.getText();
				...
				try {
					hull_colour = ingestor.driver.findElement(By.xpath(
							"/html/body/div[4]/div[2]/div/div[3]/div/div/div/div[5]/div[2]/ul/li[2]/table/tbody/tr/td[2]"))
							.getText();
				...
				try {
					hull_material = ingestor.driver.findElement(By.xpath(
							"/html/body/div[4]/div[2]/div/div[3]/div/div/div/div[5]/div[1]/ul/li[2]/table/tbody/tr/td[2]"))
							.getText();
				...
				try {
					deck_material = ingestor.driver.findElement(By.xpath(
							"/html/body/div[4]/div[2]/div/div[3]/div/div/div/div[5]/div[1]/ul/li[3]/table/tbody/tr/td[2]"))
							.getText();
					ych.setDeck_material(deck_material);
				} catch (Exception e) {
					// TODO: handle exception
				}

				try {
					hull_configuration = ingestor.driver.findElement(By.xpath(
							"/html/body/div[4]/div[2]/div/div[3]/div/div/div/div[5]/div[1]/ul/li[4]/table/tbody/tr/td[2]"))
							.getText();
				...
				try {
					hull_nb = ingestor.driver.findElement(By.xpath(
							"/html/body/div[4]/div[2]/div/div[3]/div/div/div/div[5]/div[1]/ul/li[1]/table/tbody/tr/td[2]"))
							.getText();
				...
				try {
					interior_designer = ingestor.driver.findElement(By.xpath(
							"/html/body/div[4]/div[2]/div/div[3]/div/div/div/div[5]/div[2]/ul/li[5]/table/tbody/tr/td[2]"))
							.getText();
				...
				try {
					exterior_designers = ingestor.driver.findElement(By.xpath(
							"/html/body/div[4]/div[2]/div/div[3]/div/div/div/div[5]/div[2]/ul/li[4]/table/tbody/tr/td[2]"))
							.getText();
				...
				try {
					naval_architect = ingestor.driver.findElement(By.xpath(
							"/html/body/div[4]/div[2]/div/div[3]/div/div/div/div[5]/div[2]/ul/li[1]/table/tbody/tr/td[2]"))
							.getText();
					ych.setNaval_architect(naval_architect);
				} catch (Exception e) {
					// TODO: handle exception
				}
				...
				try {
					fuel_type = ingestor.driver.findElement(By.xpath(
							"/html/body/div[4]/div[2]/div/div[3]/div/div/div/div[6]/div[2]/ul/li[2]/table/tbody/tr/td[2]"))
							.getText();
				...
				try {
					quantity = ingestor.driver.findElement(By.xpath(
							"/html/body/div[4]/div[2]/div/div[3]/div/div/div/div[6]/div[1]/ul/li[3]/table/tbody/tr/td[2]"))
							.getText();
				...
				try {
					crew = ingestor.driver.findElement(By.xpath(
							"/html/body/div[4]/div[2]/div/div[3]/div/div/div/div[4]/div[2]/ul/li[2]/table/tbody/tr/td[2]"))
							.getText();
					ych.setCrew(crew);
				} catch (Exception e) {
					// TODO: handle exception
				...
				try {
					cabins = ingestor.driver.findElement(By.xpath(
							"/html/body/div[4]/div[2]/div/div[3]/div/div/div/div[4]/div[1]/ul/li[4]/table/tbody/tr/td[2]"))
							.getText();
					ych.setCabins(cabins);
				} catch (Exception e) {
					// TODO: handle exception
				}
